...
struct Page: Identifiable, Equatable {
    ...
    Page(name: "To perform gestures, please press the 'Hold during gesture' button when performing gesture and stop after gesture is done.", description: "Turn on debug mode to show probabilities for each prediction.", imageUrl: "sec", videoUrl: "",tag: 1),
