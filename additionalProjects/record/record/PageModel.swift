...
struct Page: Identifiable, Equatable {
    ...
    Page(name: "To perform gestures, please press the record button when performing gesture and stop after gesture is done.", description: "", imageUrl: "sec", videoUrl: "",tag: 1),
    Page(name: "After performing gesture, corresponding sound will be made.", description: "There are 2 preprogrammed gestures (wave/updown). Any unrecognized gestures will be classified 'Other'.", imageUrl: "third", videoUrl: "",tag: 2),
